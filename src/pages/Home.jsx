...
const Home = () => {
  ...
  const [SliceProducts, setSliceProducts] = useState(3);
  ...
  const handleSlice = () => {
    setSliceProducts(prev => prev > TopProducts.length ? 3 : prev +3)
  }

  const TopItem = TopProducts.slice(0, SliceProducts).map((item) => {
